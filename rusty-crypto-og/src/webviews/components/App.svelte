...
{ #if active === Page.Use }
    ...
    <h3>Encrypt: </h3>
    <input value={encryptTxt} style="border: 2px solid gray; width:40vw;" />
    ...
    <h3>Decrypt: </h3>
    <input value={decryptTxt} style="border: 2px solid gray; width:40vw;" />
